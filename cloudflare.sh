...
auth_email="aungmyo.agriculture@gmail.com"                                       # The email used to login 'https://dash.cloudflare.com'
auth_method="token"                                 # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key="kXn3H3Ofe4k4nVhkkznG9q1kSqw8agfN9lQ27zfK"                                         # Your API Token or Global API Key
zone_identifier="ace674ebf633a0cb4cdadfb8f25b8152"                                  # Can be found in the "Overview" tab of your domain
record_name="shellone.aoso2.site"                                      # Which record you want to be synced
